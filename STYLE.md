...
| -------------- | ----------------------------------------------------------------- | ----------------------- | ------------------------------- | --------------------------------------------------------------------------------- |
| **Journey**    | Long, multi-phase, run once against a site                        | Verb-first              | Yes — `.cloudcannon/migration/` | `migrating-to-cloudcannon`, `make-site-multilingual`                              |
...
| **Operation**  | Short, symptom- or task-driven, against a site that already works | Verb-first              | No                              | `translate-multilingual`                                                          |
