...
| **Capability** | One CloudCannon feature; delegated to, or entered directly        | `cloudcannon-<feature>` | No                              | `cloudcannon-configuration`, `cloudcannon-snippets`, `cloudcannon-visual-editing`, `cloudcannon-dev-server` |
